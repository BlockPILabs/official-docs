---
description: >-
  This page serves as a Fantom API documentation index and lists the available
  JSON-RPC methods.
---
...
* [eth\_getBalance](eth_gasprice.md)
...
* [eth\_newPendingTransactionFilter](eth_newpendingtransactionfilter.md)
* [eth\_getFilterChanges](eth_getfilterchanges.md)
* [eth\_signTransaction](eth_signtransaction.md)
* [eth\_uninstallFilter](eth_uninstallfilter.md)
* [eth\_subscribe](eth_subscribe.md)
* [eth\_unsubscribe](eth_unsubscribe.md)
...
### Txpool <a href="#web3_sha3" id="web3_sha3"></a>
...
### Trace (Only available with Archive Mode)

* [trace\_block](trace_block.md)
* [trace\_transaction](trace_transaction.md)
* [trace\_filter](trace_filter.md)
* [trace\_get](trace_get.md)
