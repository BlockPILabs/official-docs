---
description: >-
  Returns information about a header by number. This API works only on RPC call,
...
| Type             | Description                                                           |
| ---------------- | --------------------------------------------------------------------- |
| QUANTITY \| TAGA | Integer or hexadecimal block number, or the string `"earliest"`, `"l` |
