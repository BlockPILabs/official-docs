---
description: >-
  This page serves as an Polygon API documentation index and lists the available
  JSON-RPC methods.
---
...
* [eth\_getBlockTransactionCountByHash](eth_getblocktransactioncountbyhash.md)
...
* [eth\_newFilter](eth_newfilter.md)
* [eth\_newBlockFilter](eth_newblockfilter.md)
* [eth\_getFilterLogs](eth_getfilterlogs.md)
...
## web3 <a href="#net_peercount-1" id="net_peercount-1"></a>
...
* [debug\_traceCall](debug_tracecall.md)
...
## zkEvm(only for Polygon zkEVM) <a href="#zkevm-only-for-polygon-zkevm" id="zkevm-only-for-polygon-zkevm"></a>

* [zkevm\_batchNumber](zkevm_batchnumber.md)
* [zkevm\_batchNumberByBlockNumber](zkevm_batchnumberbyblocknumber.md)
* [zkevm\_consolidatedBlockNumber](zkevm_consolidatedblocknumber.md)
* [zkevm\_getBatchByNumber](zkevm_getbatchbynumber.md)
* [zkevm\_isBlockConsolidated](zkevm_isblockconsolidated.md)
